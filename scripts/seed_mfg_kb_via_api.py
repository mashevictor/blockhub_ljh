#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""将 DeepSeek 制造示范 MD 经真 multipart 上传到线上知识库并触发索引。

  python scripts/seed_mfg_kb_via_api.py https://blockhub.club
"""
...
STARTER = ROOT / "backend" / "app" / "data" / "mfg_kb_starter"
...
def main() -> int:
    ...
    for hub in HUBS:
        ...
        q = "不合格" if "quality" in hub["slug"] else "换型"
