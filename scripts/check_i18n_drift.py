...
GEN_PATHS = [
    ...
    "shared/i18n/messages/zh-CN/industry.ui.gen.json",
    "shared/i18n/messages/en-US/industry.ui.gen.json",
...
def main() -> int:
    ...
    print("==> regenerate industry UI (visual/enrich) copy")
    run([*py, "scripts/codegen-industry-ui-i18n.py"])
