...
from app.services import realestate_ops_store as store

router = APIRouter(prefix="/realestate-ops", tags=["realestate-ops"])
...
def list_api(
    ...
    if kind not in store.KINDS:
        raise HTTPException(status_code=404, detail="未知房地产能力")
