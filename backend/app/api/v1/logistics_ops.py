...
from app.services import logistics_ops_store as store

router = APIRouter(prefix="/logistics-ops", tags=["logistics-ops"])
...
def list_api(
    ...
    if kind not in store.KINDS:
        raise HTTPException(status_code=404, detail="未知物流能力")
