...
def resolve_publish_capability_keys_detailed(
    *,
    ...
    if scenario_from_tpl:
        ...
        # 现场运维 / 仓储选型勿被旧底座审批流顶替
        for win in ("device_repair", "quality_inspect", "inventory_count", "member_loyalty", "med_triage", "nurse_shift", "game_support", "school_notice", "homework_qa", "property_repair", "site_patrol", "class_schedule", "hotel_booking", "study_coach", "delivery_order", "house_viewing", "campaign_ops", "fitness_checkin", "travel_plan"):
