...
from app.services.teleai_retry import teleai_stream_with_retry
...
class TeleTtsClient:
    ...
    async def synthesize_stream(self, text: str) -> AsyncIterator[TtsChunk]:
        async def _stream() -> AsyncIterator[TtsChunk]:
        ...
        async for chunk in teleai_stream_with_retry(_stream, attempts=3):
            yield chunk
