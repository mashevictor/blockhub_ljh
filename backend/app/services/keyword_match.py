...
INDUSTRY_DEFAULT_MODULES: dict[str, list[tuple[str, str, str]]] = {
    ...
    "retail": [
        ("store_transfer", "门店调拨", "店间调拨出库"),
        ("omni_pickup", "全渠道自提", "提货码核销"),
        ("promo_coupon", "优惠券核销", "门店券码"),
        ("online_refund", "电商仅退款", "平台退款"),
        ("stock_alert", "库存预警", "低库存补货"),
        ("retail_order", "订单跟踪", "全渠道订单"),
        ("member_loyalty", "会员营销", "积分/活动/触达"),
        ("chart_dashboard", "数据看板", "零售经营看板"),
    ],
    "edu": [
        ("study_coach", "课本学习", "规划/进度/家默/考试"),
    ...
    "hotel": [
        ("room_status", "房态变更", "净房脏房维修"),
        ("hk_task", "客房打扫", "急扫/VIP"),
        ("table_reserve", "餐厅订位", "人数时段桌型"),
        ("menu_86", "菜品沽清", "档口沽清"),
        ("hotel_booking", "酒店预订", "客房入住/退房"),
        ("guest_complaint", "客诉处理", "客诉登记结案"),
        ("notify_im", "企微钉钉飞书", "预订确认推送"),
        ("chart_dashboard", "数据看板", "酒店经营看板"),
    ],
    "energy": [
        ("energy_defect", "缺陷隐患", "隐患上报闭环"),
        ("energy_ticket", "两票管理", "工作票操作票"),
        ("site_patrol", "巡检打卡", "站点巡检"),
        ("notify_im", "企微钉钉飞书", "合规推送"),
    ],
    "gov": [
        ("gov_service", "政务办事", "办事指南"),
        ("gov_appeal", "诉求受理", "市民诉求"),
        ("gov_grid", "网格事件", "网格巡查"),
        ("notify_im", "企微钉钉飞书", "进度推送"),
    ],
    "legal": [
        ("legal_case", "法务合同", "案件跟踪"),
        ("legal_filing", "立案登记", "立案入库"),
        ("legal_evidence", "证据台账", "证据登记"),
    ],
    "hr": [
        ("hire_onboard", "招聘入职", "招聘入职"),
        ("hr_perf", "绩效考核", "绩效评级"),
        ("hr_training", "培训报名", "内训报名"),
        ("leave_request", "请假审批", "请假审批"),
    ],
    "edu": [
        ("school_notice", "家校通知", "家校通知"),
        ("homework_qa", "作业答疑", "作业答疑"),
        ("class_schedule", "课表查询", "课表查询"),
        ("study_coach", "课本学习", "课本学习"),
        ("edu_grade_alert", "成绩预警", "成绩预警"),
    ],
    "logistics": [
