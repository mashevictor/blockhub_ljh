...
CORE_CAPABILITIES: list[CapabilityDef] = [
    ...
    CapabilityDef("device_repair", "设备报修", "流程审批", "DeviceRepairWidget", "approval",
                    "", ("设备报修", "报修", "扫码提单", "维修工单", "产线故障", "设备故障"),
                    menu_icon="approval", route="/device-repair"),
    ...
    CapabilityDef("notify_im", "企微钉钉", "通知集成", "IMWidget", "notify",
                    "", ("企微", "钉钉", "企业微信", "飞书"),
                    web_pkg="@blockhub/web-capability-integration", menu_icon="bell", route="/im"),
