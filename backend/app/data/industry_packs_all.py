...
_MFG = {
    ...
    "scenes": [
        ...
        _scene("物料领用", "物料管理", "生产领退料", agent="approval"),
        _scene("安环隐患上报", "安全管理", "安全隐患拍照上报", pages="form+approval", agent="approval"),
        _scene("排班/考勤", "人事管理", "班次查询申诉", pages="list+approval", agent="approval"),
        _scene("保养计划提醒", "设备管理", "设备保养到期", pages="notify", agent="notify"),
        _scene("图纸/BOM检索", "知识管理", "工程文档问答", pages="kb", agent="kb"),
        _scene("对接MES/ERP", "系统集成", "制造系统打通", standard="定制", pages="integration", agent="integration"),
        _scene("能耗/碳排统计", "绿色制造", "绿色制造指标", pages="chart", standard="部分", agent="report"),
        _scene("技能培训记录", "人事管理", "上岗证培训档案", pages="list+kb", agent="kb"),
    ],
}
