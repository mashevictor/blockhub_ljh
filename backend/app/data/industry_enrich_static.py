...
PACK_CAPSHIP_MODULES: dict[str, list[str]] = {
    ...
    "energy": [
        ...
        "approval_flow", "chart_dashboard", "notify_im", "kb_document",
    ],
    "gov": [
        "gov_service", "gov_appeal", "gov_grid", "gov_license", "gov_hotline",
        "chat_qa", "kb_document", "approval_flow", "chart_dashboard", "notify_im",
    ],
    "legal": [
        "legal_case", "legal_filing", "legal_evidence", "legal_hearing", "legal_contract_ops",
        "kb_document", "chat_qa", "approval_flow", "notify_im",
    ],
    "hr": [
        "hire_onboard", "leave_request", "policy_qa",
        "hr_perf", "hr_training", "hr_headcount", "hr_payroll",
        "approval_flow", "kb_document", "notify_im",
    ],
    "marketing": [
        "campaign_ops", "mkt_lead", "mkt_content", "sales_lead",
        "chart_funnel", "approval_flow", "notify_im", "chat_qa",
    ],
    "construction": [
        "site_patrol", "deco_material", "const_safety", "const_accept", "const_progress",
        "approval_flow", "notify_im", "kb_document", "chart_dashboard",
    ],
    "agriculture": [
        "agro_patrol", "agro_subsidy", "agro_inventory",
        "kb_document", "approval_flow", "notify_im", "chart_dashboard", "chat_qa",
    ],
    "media": [
        "campaign_ops", "media_review", "media_calendar",
        "kb_document", "approval_flow", "notify_im", "chat_qa", "chart_dashboard",
    ],
    "auto": [
        "auto_service", "auto_fleet", "device_repair", "sales_lead",
        "chat_qa", "approval_flow", "notify_im", "chart_dashboard",
    ],
}
