...
import { PLAZA_MOCK_FEED, PLAZA_TRENDS, type PlazaFeedItem } from '../data/plazaMock'
    ...
    <div className="plaza-page">
      <header className="plaza-topbar">
        ...
        <nav className="plaza-topbar-nav">
          <Link to="/">创建应用</Link>
          <Link to="/plaza" className="on">广场</Link>
          <Link to="/" className="plaza-topbar-my" onClick={(e) => {
            e.preventDefault()
      ...
      <div className="plaza-layout">
        <aside className="plaza-side">
          <h4>导航</h4>
          <Link to="/">🏠 创建应用</Link>
          <Link to="/plaza" className="on">📡 广场 · Newsfeed</Link>
          <Link to="/">📱 我的应用</Link>
          <p className="plaza-side-note">方案 B 已定稿 · 当前为演示 Mock 数据</p>
        </aside>
