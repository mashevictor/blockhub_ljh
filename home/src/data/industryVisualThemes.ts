...
export const INDUSTRY_VISUAL_THEMES: Record<string, IndustryVisualTheme> = {
  ...
  realestate: {
    ...
    pattern: 'waves',
    motif: '🏠',
    stats: [{ value: '22', label: '地产场景' }, { value: '真表', label: '租赁物业' }, { value: '看房', label: '签约' }],
    highlights: ['看房预约 · 签约认购 · 物业报修', '租金收缴 · 装修验收 · 业主投诉', '房源上架与楼盘经营真聚合'],
    focusModules: ['house_viewing', 'property_repair', 'listing_publish', 'rent_collection'],
    heroPitch: '地产全周期 · 看房签约租赁物业真闭环',
  },
  hotel: {
    key: 'hotel',
    layout: 'hospitality',
