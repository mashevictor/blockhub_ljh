...
export const INDUSTRY_VISUAL_THEMES: Record<string, IndustryVisualTheme> = {
  ...
  sales: {
    ...
    pattern: 'diagonal',
    motif: '📈',
    stats: [{ value: '12', label: '销售场景' }, { value: '漏斗', label: '商机转化' }, { value: 'CRM', label: '可同步' }],
    highlights: ['产品话术问答 · 报价折扣审批 · 销售漏斗看板', '外勤签到 + 区域分析助力一线', '合同会签与商机到期提醒'],
    focusModules: ['chat_qa', 'approval_flow', 'chart_funnel', 'kb_document'],
    heroPitch: '销售增长引擎 · 话术、漏斗、合同、CRM',
  },
  med: {
    key: 'med',
    layout: 'clinical',
  ...
  game: {
    ...
    pattern: 'dots',
    motif: '🎮',
    stats: [{ value: '13', label: '游戏场景' }, { value: 'FAQ', label: '玩家服务' }, { value: 'UGC', label: '内容风控' }],
    highlights: ['玩家 FAQ/攻略 · 客服工单 · 活动上线通知', '版号合规审查 · NPC 角色对话', '留存 ARPU 看板 + 渠道 ROI'],
    focusModules: ['chat_qa', 'approval_flow', 'kb_document', 'notify_inapp'],
  ...
  logistics: {
    ...
    pattern: 'diagonal',
    motif: '📦',
    stats: [{ value: '10', label: '物流场景' }, { value: 'GPS', label: '在途可视' }, { value: '冷链', label: '监控' }],
    highlights: ['运单跟踪 · 仓储盘点 · 车辆调度', '签收确认 · 运费结算', '路线优化与装卸排队'],
    focusModules: ['approval_flow', 'notify_inapp', 'chart_dashboard', 'integration'],
    heroPitch: '智慧物流 · 运单、仓储、调度、签收',
  },
  realestate: {
    key: 'realestate',
    layout: 'estate',
