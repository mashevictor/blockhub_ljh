...
export const ROLE_PRESETS: RolePreset[] = [
  scene('s00', '上海话语音助手', '方言 · 交互', '#e11d48',
    ...
    ['>> 上海话语音 · 开口即说', '>> 实时 ASR · 方言识别', '>> 智能问答 · 语音播报', '>> 网页/APK · 一键生成'], '沪语用户'),
  ...
  scene('s08', '设备报修', '制造 · 运维', '#3b82f6',
    ...
    ['>> 设备报修 · 扫码提单', '>> 工单派发 · 进度跟踪', '>> 企微钉钉飞书 · 状态推送', '>> CapShip · 双端真接口'], '制造'),
  ...
  scene('s09', '质检SOP', '制造 · 工艺', '#0ea5e9',
    ...
    ['>> 质检SOP · 批次工序录入', '>> 合格/不合格 · 当场判定', '>> 企微钉钉飞书 · 异常推送', '>> CapShip · 双端真接口'], '质检'),

  scene('s10', '全渠道自提', '零售 · 履约', '#f97316',
    '线上下单到店自提、调拨与券核销。',
    [
      { type: 'industry', key: 'retail', label: '零售电商' },
      { type: 'scenario', key: 's10-stock', label: '全渠道自提' },
      { type: 'module', key: 'omni_pickup', label: '全渠道自提' },
      { type: 'module', key: 'store_transfer', label: '门店调拨' },
      { type: 'module', key: 'notify_im', label: '企微钉钉飞书' }
    ],
    ['>> 全渠道自提 · 提货码核销', '>> 门店调拨 · 店仓真表', '>> 企微钉钉飞书 · 到店通知', '>> CapShip · 双端真接口'], '零售'),
  ...
  scene('s11', '会员营销', '零售 · 运营', '#fb923c',
    ...
    ['>> 会员营销 · 积分活动登记', '>> 券码/积分 · 待触达确认', '>> 企微钉钉飞书 · 活动推送', '>> CapShip · 双端真接口'], '运营'),
  ...
  scene('s12', '医疗导诊', '医院 · 患者', '#10b981',
    ...
    ['>> 医疗导诊 · 症状预问诊', '>> 推荐科室 · 就诊指引', '>> 企微钉钉飞书 · 提醒推送', '>> CapShip · 双端真接口'], '医护'),
  ...
  scene('s15', '家校通知', '教育 · 家长', '#22c55e',
    ...
    ['>> 家校通知 · 活动公告推送', '>> 报名留言 · 在线互动', '>> 企微钉钉飞书 · 家长触达', '>> CapShip · 双端真接口'], '家长'),
  ...
  scene('s16', '作业答疑', '教育 · 学生', '#3b82f6',
    ...
    ['>> 作业答疑 · 页码题号卡点', '>> Soft 步进 · 提交真库', '>> 企微钉钉飞书 · 批改通知', '>> CapShip · 双端真接口'], '学生'),
  ...
  scene('s17', '课表查询', '校园 · 日程', '#2563eb',
    ...
    ['>> 课表 · 课程考试登记', '>> 日期时段 · Soft 步进', '>> 企微钉钉飞书 · 日程提醒', '>> CapShip · 双端真接口'], '学生'),
  ...
  scene('s19', '物业报修', '生活 · 社区', '#78716c',
    ...
    ['>> 物业报修 · 业主扫码提单', '>> 派工维修 · 进度跟踪', '>> 企微钉钉飞书 · 状态推送', '>> CapShip · 双端真接口'], 4, '业主'),
  ...
  scene('s28', '巡检打卡', '能源 · 安全', '#eab308',
    ...
    ['>> 巡检打卡 · 站点点位录入', '>> 合格/隐患 · 当场闭环', '>> 企微钉钉飞书 · 合规推送', '>> CapShip · 双端真接口'], '巡检'),
  ...
  scene('s32', '课本学习', '教育 · 学生', '#6366f1',
    ...
    ['>> 课本 · 书名定位册次', '>> 大纲 · Module/Unit 规划', '>> 家默复习考试 · Soft 步进', '>> CapShip · 双端真接口'], 5, '学生'),
  ...
  scene('s33', '家默督导', '教育 · 家长', '#8b5cf6',
    ...
    ['>> 家默 · 听写错词得分', '>> 选单元 · Soft 步进', '>> 企微钉钉飞书 · 提醒推送', '>> CapShip · 双端真接口'], 4, '家长'),
  ...
  scene('s34', '教学规划', '教育 · 老师', '#4f46e5',
    ...
    ['>> 教学规划 · 课本大纲', '>> 测验家默 · 掌握度跟进', '>> 作业答疑 · Soft 批改', '>> CapShip · 双端真接口'], 4, '老师'),
  ...
  scene('s35', '银行KYC', '银行 · 开户', '#0369a1',
    ...
    ['>> 金融KYC · 客户核验', '>> Soft 步进 · 提交真库', '>> 企微钉钉飞书 · 开户提醒', '>> CapShip · 双端真接口'], '银行'),
  ...
  scene('s36', '反洗钱监测', '银行 · 合规', '#b91c1c',
    ...
    ['>> 反洗钱 · 预警登记', '>> Soft 步进 · 研判归档', '>> 企微钉钉飞书 · 合规推送', '>> CapShip · 双端真接口'], '合规'),
  ...
  scene('s37', '授信审批', '银行 · 信贷', '#1d4ed8',
    ...
    ['>> 授信审批 · 额度担保', '>> Soft 步进 · 真库闭环', '>> 企微钉钉飞书 · 审批通知', '>> CapShip · 双端真接口'], '信贷'),
  ...
  scene('s38', '核保理赔', '保险 · 承保', '#0284c7',
    ...
    ['>> 核保理赔 · 保单客户', '>> Soft 步进 · 办结真库', '>> 企微钉钉飞书 · 案件通知', '>> CapShip · 双端真接口'], '保险'),
  ...
  scene('s39', '监管报送', '资管 · 合规', '#4338ca',
    ...
    ['>> 监管报送 · 报表周期', '>> Soft 步进 · 标记已报', '>> 企微钉钉飞书 · 截止提醒', '>> CapShip · 双端真接口'], '资管'),

  scene('s40', '行业新闻', '金融 · 情报', '#0f766e',
    '宏观/微观必读摘要与热议流；演示样本或一键真源入库。',
    [
      { type: 'industry', key: 'bank', label: '商业银行' },
      { type: 'scenario', key: 's40-news', label: '行业新闻 Agent' },
      { type: 'module', key: 'finance_news', label: '行业新闻Agent' }
    ],
    ['>> 行业新闻 · 必读摘要', '>> 演示样本 · source=demo', '>> Token · 一键真源同步', '>> CapShip · 双端真接口'], 5, '投研'),
]
