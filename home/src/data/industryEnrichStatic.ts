...
const PACK_COPY: Record<string, { overview: string; highlights: string[]; tipScenes: Array<{ name: string; tip: string }> }> = {
  ...
  finance: {
    overview: '金融服务深度包强调合规审查、风控预警与合同管理，满足审计留痕要求。',
    highlights: ['合规审查', '风控预警', '合同会签', '产品解读'],
    tipScenes: [
      { name: '合规审查', tip: '业务合规自检；审批+知识库。' },
      { name: '风控预警', tip: '异常交易预警；通知+看板。' },
      { name: '合同审批', tip: '多级会签；legal_case / 审批。' },
      { name: '理财问答', tip: '产品说明问答；chat_qa + kb。' },
    ],
  },
  logistics: {
    overview: '物流仓储深度包打通运单跟踪、仓储盘点与配送调度，异常可闭环。',
    highlights: ['运单跟踪', '仓储盘点', '配送异常', '冷链告警'],
    tipScenes: [
      { name: '运单跟踪', tip: '在途可视；delivery_order + 通知。' },
      { name: '仓储盘点', tip: '周期盘点；inventory_count。' },
      { name: '签收确认', tip: '电子签收与异常登记。' },
      { name: '冷链监控', tip: '温湿度告警；通知+看板。' },
    ],
  },
  realestate: {
    overview: '房地产深度包覆盖看房签约、物业报修与租金催收。',
    highlights: ['看房预约', '签约审批', '物业报修', '租金催收'],
    tipScenes: [
      { name: '看房预约', tip: '档期预约；house_viewing。' },
      { name: '物业报修', tip: '业主报修；property_repair。' },
      { name: '签约审批', tip: '认购签约多级审批。' },
      { name: '租金收缴', tip: '账单与催收通知。' },
    ],
  },
  hotel: {
