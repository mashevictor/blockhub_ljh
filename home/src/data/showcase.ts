...
export const INDUSTRIES_SHOWCASE: IndustryItem[] = [
  ...
  { key: 'mfg', name: '传统制造', iconKey: 'mfg', count: 14, desc: '报修、双知识库、质检、MES', color: '#3b82f6', fullPack: true },
  ...
  { key: 'game', name: '游戏娱乐', iconKey: 'game', count: 14, desc: 'FAQ工单真库、双知识库、活动通知、2048', color: '#a855f7', fullPack: true },
  ...
  { key: 'bank', name: '商业银行', iconKey: 'finance', count: 8, desc: '对公零售、KYC、授信、反洗钱', color: '#0369a1', fullPack: true },
  { key: 'securities', name: '证券券商', iconKey: 'finance', count: 8, desc: '适当性、投研尽调、合规、销售', color: '#0e7490', fullPack: true },
  { key: 'insurance', name: '保险', iconKey: 'finance', count: 7, desc: '核保、理赔、代理人、产品说明', color: '#0284c7', fullPack: true },
  { key: 'fund', name: '基金资管', iconKey: 'finance', count: 7, desc: '产品披露、投后、监管报送', color: '#1d4ed8', fullPack: true },
  { key: 'fintech', name: '消金金科', iconKey: 'finance', count: 8, desc: '风控预警、贷后、监管报送', color: '#4338ca', fullPack: true },
...
export const SCENARIO_BREAKDOWN = [
  ...
  { label: '游戏', count: 14, color: '#a855f7', iconKey: 'game' },
]
...
const INDUSTRY_ICONS_FALLBACK: Record<string, string> = {
  ...
  '审批流程': 'approval', '客户管理': 'sales', '玩家服务': 'game', '客服管理': 'game',
