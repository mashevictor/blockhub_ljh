...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    story: [
      ...
      '**可转发材料**：案例详情与 [一页纸摘要](/downloads/one-pager-mfg.html) 可在 [落地案例](/cases) 下载；同行业客户可参考 [制造行业方案](/industry/mfg) 场景清单。',
    ...
    onePagerPath: '/downloads/one-pager-mfg.html',
  },
  {
    slug: 'retail-office',
    name: '连锁零售 · 智慧办公',
    ...
    story: [
      ...
      '**推广节奏**：总部 HR 先试点 2 周，再向 120 家门店分批开放；详见 [一页纸摘要](/downloads/one-pager-retail.html)。',
    ],
    pilotNote: '标准 PaaS 部署，2 周完成制度文档整理与首批场景上线。',
    onePagerPath: '/downloads/one-pager-retail.html',
  },
  {
    ...
    story: [
      ...
      '更多物流场景见 [物流行业方案](/industry/logistics) 与 [一页纸摘要](/downloads/one-pager-logistics.html)。',
    ],
    pilotNote: '试点周期 14 天，用 500 条历史运单脱敏数据验证准确率。',
    onePagerPath: '/downloads/one-pager-logistics.html',
  },
]
