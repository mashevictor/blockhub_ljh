...
final Map<String, CapabilityModule> generatedMelosModuleByKey = {
    'finance_kyc': FinanceModule(capabilityKey: 'finance_kyc'),
    'finance_aml': FinanceModule(capabilityKey: 'finance_aml'),
    'credit_approval': FinanceModule(capabilityKey: 'credit_approval'),
